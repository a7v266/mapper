...
public class GeneratorServiceImpl implements GeneratorService {
    ...
    public void generateData() {
        Writer writer1 = writerRepository.save(new Writer(1L, "Писатель 1"));
        Writer writer2 = writerRepository.save(new Writer(2L, "Писатель 2"));
        Writer writer3 = writerRepository.save(new Writer(3L, "Писатель 3"));
